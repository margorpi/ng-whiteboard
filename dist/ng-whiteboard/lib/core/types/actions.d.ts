...
export type WhiteboardAction = {
    ...
    payload: {
        elementOrId: WhiteboardElement | string;
    };
} | {
    ...
    payload: {
        partialElement: Partial<WhiteboardElement>;
    };
} | {
    ...
    type: ActionType.RenameLayer;
    payload: {
        id: string;
        name: string;
    };
} | {
    type: ActionType.SetActiveLayer;
    payload: {
        id: string;
    };
} | {
    type: ActionType.ToggleLayerVisibility;
    payload: {
        id: string;
    };
} | {
    type: ActionType.ToggleLayerLock;
    payload: {
        id: string;
    };
} | {
    type: ActionType.SetLayerOpacity;
    payload: {
        id: string;
        opacity: number;
    };
} | {
    type: ActionType.SetLayerBlendMode;
    payload: {
        id: string;
        blendMode: string;
    };
} | {
    type: ActionType.MoveLayerUp;
    payload: {
        id: string;
    };
} | {
    type: ActionType.MoveLayerDown;
    payload: {
        id: string;
    };
};
